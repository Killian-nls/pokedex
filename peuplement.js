async function main() {
    ...
    for (let i = 1; i <= count; i++) {
        ...
        const imagePath = `https://img.pokemondb.net/sprites/home/normal/${pokemonInfo.name}.png`;
...
async function addPokemon(pokemon) {
    const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2N2FkYmIyNTA5ZTAwM2FiZmVkNjRhN2IiLCJpYXQiOjE3Mzk5NjA4MTUsImV4cCI6MTczOTk3NTIxNX0.SImMRn3qB0xm8kZbC_z30wlV_O66d7dBJfwZBlz9so4"
